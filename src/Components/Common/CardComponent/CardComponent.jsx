    ...
    return(
        <div className="card">
            ...
            <div className="card__subscribers">
                <span className="card__subscribers-item">{data.subscribers} subscribers</span>
                <span>3.8</span>
            </div>
            <div className="card__details">
                <div className="card__details-dataQuality">
                    <span className="card__details-dataQuality-name">Data Quality</span>
                    <span className="card__details-dataQuality-value">{data.dataQualityd}</span>
                </div>
            ...
            <div className="card__details">
                <div className="card__details-dataQuality">
                    ...
                    <span className="card__details-dataQuality-value">{data.dataSecurity}</span>
                </div>
                <div className="card__details-domain">
