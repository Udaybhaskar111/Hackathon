    ...
    <div className="JobDetails">
      ...
      <div className="JobDetails__Job">
        ...
        <ul className="JobDetails__Job__Summary__List">
          <li className="JobDetails__Job__Summary__List__L1">
            {' '}
            Develop And Maintain An Effective Data Architecture And Cloud
            Strategy Aligned With Organization Goals.
          </li>
          <li className="JobDetails__Job__Summary__List__L2">
            {' '}
            Design, Implement,And Manage ETL Processes On Cloud
            Platforms,Ensuring Scalability,Reliability,And Cost-Efficiency.
          </li>
          <li className="JobDetails__Job__Summary__List__L3">
            Utilize Cloud Services(E.G.,AWS
            S3,Glue,EMR,Redshift,Lambda,Kinesis)For Building And Optimizing Data
            Pipelines And Storage Solutions.
          </li>
          <li className="JobDetails__Job__Summary__List__L4">
            Advocate FOr And Optimize Data Lakehouse Architecture For Analytical
      ...
      <div className="JobDetails__Qualifications">
        ...
        <ul className="JobDetails__Qualifications__Studied">
          <li className="JobDetails__Qualifications__S1">
            Bachelors Or Higher Degree In A Relevant Field.
          </li>
          <li className="JobDetails__Qualifications__S2">
            5+ Years Of Proven Experience In Data Engineering,Cloud
            Architecture,And ETL Processes.
          </li>
          <li className="JobDetails__Qualifications__S3">
            Extensive Knoweledge Of Data Lakehouse
            Technologies,Hudi,Dbt,Airbyte,Redshift,Glue,Kinesis,And Apache
            Airflow.
          </li>
          <li className="JobDetails__Qualifications__S4">
            Strong Expertise In Programming Languages Like SQL,Python,And
            Processing Frameworks Like PySpark.
          </li>
          <li className="JobDetails__Qualifications__S5">
            Strong Expertise In Real-Time Data Processing.
          </li>
          <li className="JobDetails__Qualifications__S6">
            Excellent Problem-Solving And Analytical Skills.
          </li>
          <li className="JobDetails__Qualifications__S7">
      ...
      <div className="JobDetails__Requried">
        ...
        <p className="JobDetails__Required__RS">
          ApacheNifi,Microsoft SSIS,SQL,Python,Data Warehousing,AWS
          Kinesis,Apache Kafka,Data Governance,Version Control
        </p>
      </div>
